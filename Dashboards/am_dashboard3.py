...
option = st.selectbox(
     ...
     focus_data['Account Manager'].unique())

st.write('Account Manager selected:', option)

focus_data = focus_data.loc[focus_data['Account Manager'] == option]
...
# Plot histogram
#sns.histplot(data = attriting2['Days On Platform'], kde = True)
...
rp = rp.loc[((rp['RP 1']==1.0) | (rp['RP 2']==1.0) | (rp['RP 3']==1.0))]
...
rp_2_count = len(rp.loc[rp['RP 2']== 1.0])
...
lg = lg.loc[((lg['Alan LG 1 Group']==1.0) | (lg['LG 2']==1.0))]
